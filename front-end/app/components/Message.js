    ...
    return (
        <div className="dataset-info-wrapper" id={message.id}>
            <div className={`${message.role}-message d-flex`}>
                {message.role == 'user' ? (
                    <div class="d-flex justify-content-end user-message">
