...
class DatasetSerializer(serializers.ModelSerializer):
    ...
    def create(self, data):
        ...
        for sheet_name, df in dfs.items():
            ...
            # Start an agent to handle the sub table extraction, even though we do the first bit manually 
            ...
            system_message = render_to_string('prompt.txt', context={'agent': agent, 'agent_datasetframes': [dataset_frame] })
